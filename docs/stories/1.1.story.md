...
- [ ] **Task 6: Opprett Health Check Endpoint** (AC: 7)
  - [ ] Opprett `app/api/health/route.ts`
  - [ ] Implementer GET handler som returnerer `{ status: "ok", timestamp: ISO-string }`
  - [ ] Verifiser at endpointet fungerer: `curl http://localhost:3000/api/health`

- [ ] **Task 7: Opprett README.md** (AC: 8)
  - [ ] Skriv prosjektbeskrivelse (DevHub - utvikler-community plattform)
  - [ ] Dokumenter prerequisites (Node.js 18+, pnpm 8+)
  - [ ] Dokumenter setup-steg (clone, install, env, dev)
  - [ ] Inkluder tilgjengelige scripts
  - [ ] Legg til tech stack oversikt

- [ ] **Task 8: Opprett .env.example** (AC: 8)
  - [ ] Dokumenter alle nødvendige environment variables
  - [ ] Inkluder kommentarer som forklarer hver variabel
  - [ ] Inkluder placeholder-verdier der mulig
